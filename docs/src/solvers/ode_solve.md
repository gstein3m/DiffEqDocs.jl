...
#### Rosenbrock Methods
  ...
  - `Rodas3P` - 3rd order A-stable and stiffly stable Rosenbrock method with a
    stiff-aware 3rd order interpolant and additional error test for the interpolation.
    Keeps high order accuracy on discretizations of nonlinear parabolic PDEs.
...
#### Rosenbrock-W Methods
  ...
  - `Rodas23W` - An Order 2/3 L-Stable Rosenbrock-W method which is good for DAEs and
    discretizations of nonlinear parabolic PDEs. 2nd order stiff-aware interpolation and
    additional error test for the interpolation.
